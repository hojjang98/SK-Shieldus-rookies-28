...
| **Week 17** | 🏗️ 수탁사 현황 시나리오 스케치 | 파이널 프로젝트 수탁사 후보 9개 시나리오 초안 작성. 위탁사: 하랑항공 (연간 탑승객 1,500만명, 회원 800만명). 수탁사별 위탁 업무·처리 개인정보·주요 컴플라이언스 이슈 정의. 케이터링(하랑케이터링) · 클라우드(스카이클라우드) · 콜센터 · 물류 · 금융 등 업종별 현실적 취약점 도출. 개인정보보호법 제26조(재위탁 사전 승인), 제23조(민감정보), 제21조(파기) 중심 법적 이슈 매핑 |
