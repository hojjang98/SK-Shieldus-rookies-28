...
### 관련하여 더 공부해야 할 내용
- [ ] 액세스 토큰과 서명키(Signing Key)의 작동 원리 및 생명주기 관리 방법
- [ ] 특권 계정 관리(PAM, Privileged Access Management) 솔루션
- [ ] UEBA(User and Entity Behavior Analytics)를 통한 이상 행위 탐지 기법
- [ ] 제로 트러스트 아키텍처 구현 사례
- [ ] 퇴사자 오프보딩(Offboarding) 보안 체크리스트 및 자동화 방법
- [ ] ISMS-P 인증 기준과 실제 보안 운영 간의 갭 분석
- [ ] 패스키(FIDO2/WebAuthn) 기술 및 도입 전략
