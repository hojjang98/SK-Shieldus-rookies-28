...
### 관련하여 더 공부해야 할 내용
- [ ] 딥페이크 생성 기술의 원리 (GAN, Diffusion Model 등)
- [ ] 딥페이크 탐지 기술 및 최신 연구 동향
- [ ] 생체 인증(Liveness Detection) 기술
- [ ] 북한 APT 그룹의 전술, 기법, 절차(TTP)
- [ ] 국제 제재 체계와 컴플라이언스
- [ ] HR 보안(HR Security) 및 채용 프로세스 보안 강화 방법
- [ ] UEBA(User and Entity Behavior Analytics) 솔루션
- [ ] 소셜 엔지니어링 방어 기법
- [ ] 원격 근무 환경의 보안 모범 사례
- [ ] AI 윤리 및 악용 방지 기술 (AI Safety)
