...
이번 사건에서 주목할 점은 IT 인프라가 침해됐음에도 SCADA 시스템과 운영 기술 네트워크가 영향을 받지 않았다는 것이다. 이는 IT와 OT 네트워크 분리(IT-OT segmentation)가 효과적으로 작동한 사례다. 만약 OT까지 침해됐다면 루마니아 전국 정유소 공급이 중단되는 물리적 피해로 이어졌을 것이다.
