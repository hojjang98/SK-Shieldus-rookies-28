# 📄 2025.02.24 (Day 79) - 파이널 프로젝트 3차 팀 회의: 수탁사 확정 및 프레임워크 구성
...
**팀장 제안 내용:**
```
핀테크 개인정보 위·수탁 관리체계 컨설팅 프레임워크 (5단계)
...
개인 준비 사항:
  - 파트 A 수탁사 6개 상세 조사 완료
    (수탁사명 / 위탁 업무 / 처리 개인정보 / 사고 사례 / 적용 법령)
  - WBS 초안 검토 참여 준비
...
```
유형 B — 본인인증·신원확인:
  1. (주)케어인증      — 본인확인 및 CI/DI 생성 중계
  2. (주)아이덴티티    — AI 기반 OCR 신분증 판독
  3. (주)테크솔루션    — 블록체인 기반 인증 및 지갑 관리
  4. (주)케이크레딧    — 신용조회 중계, 간편인증, i-PIN
  5. (주)패스인증      — 통신사 기반 휴대폰 본인확인
  6. (주)바이오아이디  — 안면인식·지문 기반 생체인증
```
