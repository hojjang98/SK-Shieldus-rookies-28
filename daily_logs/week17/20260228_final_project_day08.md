...
- 보안기사 - 컨설팅 전반 이해에 도움
- 그림으로 배우는 보안구조 (교보문고)
- 개인정보포털 자료실 (안내서): https://www.privacy.go.kr
...
- 제주항공, 진에어, 티웨이항공, 에어부산, 에어서울, 에어로케이
```
...
4. 체크리스트 항목 (구분, 범주, 영역, 점검 항목, 점검 방법, 법령 조항, 점검 내역, 증적명)
   기준으로 I열(점검 내역)과 증적을 채워나가는 방식
...
```
핵심 인사이트:
SKT 유통망 점검 구조(대리점 위수탁 점검)가
우리 프로젝트(항공사 수탁사 점검)와 동일한 구조임을 확인.
실제 현업에서 동일한 방식으로 수행되는 컨설팅 프로젝트라는 점에서
오늘 프로젝트 방향의 현실성이 검증된 셈이다.
```
...
- **권순영 팀장님 자료 활용:** WSTS에 있는 2월 자료를 WBS 작성 전에 반드시 참고
