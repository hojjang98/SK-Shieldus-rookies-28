...
[2] Witte, K. (1994). Fear control and danger control: A test of the Extended Parallel Process Model (EPPM). *Communication Monographs*, 61, 113–134.

[3] Dolan, P., Hallsworth, M., Halpern, D., King, D., & Vlaev, I. (2010). MINDSPACE: Influencing behaviour through public policy. Institute for Government, Cabinet Office.

[4] Hofstede, G., Hofstede, J. G., & Minkov, M. (2010). *Cultures and Organizations: Software of the Mind* (3rd ed.). McGraw-Hill.

[5] Whitten, A., & Tygar, J. D. (1999). Why Johnny can't encrypt: A usability evaluation of PGP 5.0. *Proceedings of the 8th USENIX Security Symposium*.
